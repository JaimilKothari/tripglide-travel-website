...
const BookingConfirmation = () => {
 ...
 <p className="font-semibold">{userDetails?.name || "Varun Shah"}</p>
 </div>
 </div>
 <div className="flex items-center">
 ...
 <p className="font-semibold">{userDetails?.phone || "+91 9876543210 "}</p>
 </div>
 </div>
 <div className="flex items-center">
 ...
 <p className="font-semibold">{userDetails?.email || "varunshah314@gmail.com"}</p>
 </div>
 </div>
 <div className="flex items-center">
 ...
 <div className="text-xs text-gray-500">{(leg.stops || 0) === 0 ? "Nonstop" : `${leg.stops} stop`}</div>
 </div>
 <div>
 ...
 <p className="text-xs text-gray-500">{formatDate(leg.departureDate || departDate)}</p> {/* Updated to use departureDate */}
 </div>
 </div>
 </div>
 ))
 ...
 <p className="text-xs text-gray-500">{firstLeg?.departureAirport ? `(${firstLeg.departureAirport})` : ""}</p>
 <p className="text-sm flex items-center">
 <FaClock className="mr-1 text-xs" />
 ...
 <div className="text-xs text-gray-500">{(firstLeg?.stops || 0) === 0 ? "Nonstop" : `${firstLeg?.stops} stop`}</div>
 </div>
 <div>
 <p className="text-sm text-gray-500">To</p>
 <p className="font-semibold">{firstLeg?.arrival || "N/A"}</p>
 <p className="text-xs text-gray-500">{firstLeg?.arrivalAirport ? `(${firstLeg.arrivalAirport})` : ""}</p>
 <p className="text-sm flex items-center">
 <FaClock className="mr-1 text-xs" />
 ...
 <div className="flex justify-between items-center mb-2">
 <div className="flex items-center">
 <img src={getAirlineLogo(selectedFlight.returnFlight)} alt={selectedFlight.returnFlight?.airline || "Unknown"} className="h-8 w-8 mr-2" />
 <span className="font-semibold">{selectedFlight.returnFlight?.airline || "Unknown Airline"}</span>
 </div>
 <div className="text-sm text-gray-500">Flight {selectedFlight.returnFlight?.flightNumber || "987"}</div>
 </div>
 <div className="grid grid-cols-1 md:grid-cols-3 gap-2">
 <div>
 <p className="text-sm text-gray-500">From</p>
 <p className="font-semibold">{selectedFlight.returnFlight?.departure || "N/A"}</p>
 <p className="text-xs text-gray-500">{selectedFlight.returnFlight?.departureAirport ? `(${selectedFlight.returnFlight.departureAirport})` : ""}</p>
 <p className="text-sm flex items-center">
 <FaClock className="mr-1 text-xs" />
 ...
 <div className="flex flex-col items-center justify-center">
 <div className="text-xs text-gray-500">
 {selectedFlight.returnFlight?.duration || calculateDuration(selectedFlight.returnFlight?.departureTime, selectedFlight.returnFlight?.arrivalTime)}
 </div>
 <div className="relative w-full h-0.5 bg-gray-300 my-1">
 <div className="absolute top-1/2 right-0 transform -translate-y-1/2 -translate-x-1 w-2 h-2 rounded-full bg-blue-500"></div>
 </div>
 <div className="text-xs text-gray-500">{(selectedFlight.returnFlight?.stops || 0) === 0 ? "Nonstop" : `${selectedFlight.returnFlight?.stops} stop`}</div>
 </div>
 <div>
 <p className="text-sm text-gray-500">To</p>
 <p className="font-semibold">{selectedFlight.returnFlight?.arrival || "N/A"}</p>
 <p className="text-xs text-gray-500">{selectedFlight.returnFlight?.arrivalAirport ? `(${selectedFlight.returnFlight.arrivalAirport})` : ""}</p>
 <p className="text-sm flex items-center">
 <FaClock className="mr-1 text-xs" />
